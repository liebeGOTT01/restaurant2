...
<div class="container justify-content-center">
	<h1 class="h3 mb-4 text-gray-800 mt-5">Available Menu</h1>
		<div class="row">
			<?php 
			...
			<form method="POST">
				<div class="card mr-2 border border-transparent mb-4" style="width:15rem;">
					...
					<img class="card-img-top" src="<?php echo $newProduct['product_image'] ?>" style="height:10rem;" alt="Card image cap">
					<div class="card-body">
						<div class="row">
							<div class="col">
